      ...
      <section className="border-t py-16" style={{ background: "var(--brand-coral-10)" }}>
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2989.8!2d-81.5!3d41.45!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDHCsDI3JzAwLjAiTiA4McKwMzAnMDAuMCJX!5e0!3m2!1sen!2sus!4v1234567890!5m2!1sen!2sus&q=4853+Galaxy+Parkway+Suite+M,+Cleveland,+OH+44128"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
