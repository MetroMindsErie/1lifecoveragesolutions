...
export function QuoteStarter() {
  ...
  return (
    ...
    >
      <div className="rounded-2xl bg-white/95 backdrop-blur-xl border-2 border-white/60 p-8 shadow-2xl relative overflow-hidden">
        {/* Gradient background overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#1B5A8E]/5 via-transparent to-[#FF6B61]/5 pointer-events-none" />
        
        {/* Decorative gradient accents */}
        <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-[#FF6B61]/15 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tl from-[#1B5A8E]/15 to-transparent rounded-full blur-3xl" />
        
        <div className="relative z-10">
          <div className="mb-6">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-[#1B5A8E] to-[#2C7DB8] bg-clip-text text-transparent mb-2">
              Start Your Quote
            </h2>
            <p className="text-[#6c757d] font-medium">Select your coverage type to get started</p>
          </div>

          {/* Coverage Type Selection */}
          <div className="mb-6">
            <label className="block text-sm font-bold text-[#1B5A8E] mb-3">
          ...
          {selectedCoverage ? (
            <Button
              ...
              className="w-full h-14 text-lg font-bold bg-gradient-to-r from-[#1B5A8E] to-[#2C7DB8] hover:from-[#144669] hover:to-[#1B5A8E] text-white shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
            >
              Get My Quote
            ...
            <Button
              disabled
              className="w-full h-14 text-lg font-bold bg-gray-300 text-gray-500 cursor-not-allowed opacity-60"
            >
              Get My Quote
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
